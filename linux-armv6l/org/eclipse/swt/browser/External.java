...
void createCOMInterfaces () {
	...
	xpcScriptable = new XPCOMObject (new int[] {2, 0, 0, 1, 0, 4, 3, 3, 3, 6, 5, 6, 6, 4, 7, 7, 6, 3, 7, 5, 5, 6, 4, 2}) {
		...
		public int /*long*/ method2 (int /*long*/[] args) {return Release ();}
		@Override
		public int /*long*/ method3 (int /*long*/[] args) {return getClassName (args[0]);}
		@Override
		public int /*long*/ method4 (int /*long*/[] args) {return getScriptableFlags ();}
		@Override
		public int /*long*/ method7 (int /*long*/[] args) {return postCreate (args[0], args[1], args[2]);}
	};

	if (GetScriptableFlags24Proc != null) {
		int /*long*/ ppVtable = xpcScriptable.getVtable ();
		int /*long*/[] pVtable = new int /*long*/[1];
		C.memmove (pVtable, ppVtable, C.PTR_SIZEOF);
		int /*long*/[] funcs = new int /*long*/[24];
...
int /*long*/ getClassName (int /*long*/ aClassName) {
	int /*long*/[] result = new int /*long*/[1];
	int rc = XPCOM.NS_GetServiceManager (result);
	if (rc != XPCOM.NS_OK) Mozilla.error (rc);
	if (result[0] == 0) Mozilla.error (XPCOM.NS_NOINTERFACE);
	...
	int /*long*/ ptr = memory.Alloc (bytes.length);
	C.memmove (ptr, bytes, bytes.length);
	C.memmove (aClassName, new int /*long*/[] {ptr}, C.PTR_SIZEOF);
	memory.Release ();

	return 0;
}

static int /*long*/ getScriptableFlags () {
	return XPCOM.WANT_POSTCREATE | XPCOM.USE_JSSTUB_FOR_ADDPROPERTY;
}

int postCreate (int /*long*/ wrapper, int /*long*/ cx, int /*long*/ obj) {
	byte[] functionName = MozillaDelegate.wcsToMbcs (null, CALLJAVA, true);
	int flags = XPCOM.JSPROP_ENUMERATE | XPCOM.JSPROP_READONLY | XPCOM.JSPROP_PERMANENT;
